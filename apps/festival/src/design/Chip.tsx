...
export type ChipTone = "sky" | "plum" | "pine" | "violet" | "amber" | "bloom" | "leaf" | "sun-hot" | "sun" | "ember" | "paper";
const TONE: Record<ChipTone, string> = {
  sky: "bg-sky text-ink", plum: "bg-plum text-white", pine: "bg-pine text-white", violet: "bg-violet text-white", amber: "bg-amber text-ink", bloom: "bg-bloom text-ink", leaf: "bg-leaf text-ink", "sun-hot": "bg-sun-hot text-ink",
