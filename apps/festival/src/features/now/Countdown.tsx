...
export function Countdown({ msUntil, gatesLine }: { msUntil: number; gatesLine: string }) {
  ...
  return (
    <div className="text-center">
      ...
      <div className="flex flex-wrap items-start justify-center gap-x-2 font-shade text-[56px] leading-none text-white tabular-nums" aria-label={`${days} days ${hours} hours`}>
