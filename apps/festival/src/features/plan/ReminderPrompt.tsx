  ...
  return (
    <Card className="mt-3 flex items-center gap-3">
      <div className="min-w-0 flex-1">
        ...
        {r.showDenied && <p className="mt-0.5 text-[13px] text-danger-fg">Notifications are off for this app in Settings. <button type="button" className="underline" onClick={r.openSettings}>Open Settings</button></p>}
      </div>
