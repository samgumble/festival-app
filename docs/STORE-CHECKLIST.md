...
- ☑ Sep 15: **App access**: "All functionality is available without special access" (no login)
- ☑ Sep 15: **Ads**: No ads
- ☑ Sep 15: **Content rating** (IARC questionnaire) completed — alcohol: reference only, rarely; online content: organizer-published, no UGC; result ESRB Everyone / PEGI 3 / Play "Rated for 3+"
