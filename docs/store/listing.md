...
Lineup is the full official schedule across all four stages (Main Stage, Blues Stage, Truck Stage by Sierra Nevada®, and Campground Sessions), plus the beer tasting sessions, comedy shows, late-night Juke Joint shows, and special events, organized by day. Search by artist, switch between a list view and a stage-by-stage timeline grid, and tap any set for details.
...
```
1599 characters (events sentence added Sep 15 to match content v2026.09.14.9). Pasted into Play Sep 15; paste as-is into both Apple's Description field and Play's Full description field.
...
| Support email | `info@tellurideblues.com` (the festival's public general-inquiries address; decided Sep 15) |
| Support URL | `https://www.tellurideblues.com/contact` (decided Sep 15: all app contact goes through the festival website) |
